...
namespace WinFormsMVCDoc
{
    ...
    [HelpFileBuilderPlugInExport("WinFormsMVCDoc", Version = AssemblyInfo.ProductVersion,
      Copyright = AssemblyInfo.Copyright, Description = "WinFormsMVCDoc plug-in")]
    public sealed class WinFormsMVCDocPlugIn : IPlugIn
    {
        ...
        public void Execute(ExecutionContext context)
        {
            ...
            builder.ReportProgress("In WinFormsMVCDocPlugIn Execute() method");
        }
        #endregion
