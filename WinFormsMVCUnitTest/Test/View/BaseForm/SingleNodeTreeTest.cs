...
namespace WinFormsMVCUnitTest.Test.View.BaseForm
{
    ...
    public class SingleNodeTreeTest
    {
        ...
        public void SingleNode()
        {
            ...
            Assert.IsFalse(single_node.IsChildOf(single_node));
            Assert.IsFalse(single_node.IsChildOf(new WinFormsMVC.View.BaseForm()));
            Assert.IsFalse(single_node.IsChildOf(null));
        ...
        public void AnyInvoker()
        {
            ...
            Assert.IsTrue(single_node.IsChildOf(single_node.Invoker));
            Assert.AreEqual(0, single_node.Children.Count());
